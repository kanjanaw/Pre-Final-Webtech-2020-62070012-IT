    ...
    <body>
        <div class="container">
            ...
            <div class="row mt-2 mb-4">
                ...
                <div class="col-2">
                    <button class="btn btn-primary btn-block" type="submit" <!--onclick="myFunction()"-->>ค้นหา</button>
                </div>
            </div>
            <div id="myDIV">
                ...
                echo '<div class="col-4 pb-4"><div class="card" id="myCard"><img src="';
